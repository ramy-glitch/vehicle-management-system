    ...
    <div class="container">
        ...
        <label for="vehicle_assignment">Vehicle Assignment:</label>
                <select id="vehicle_assignment" name="vehicle_assignment">
                    ...
                    $sql = "SELECT vehicle_id, vehicle_license_plate, vehicle_type, vehicle_model,vehicle_location FROM vehicle WHERE vehicle_status = 'out_of_service'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $vehicle_location = htmlspecialchars($row["vehicle_location"]);
                            ...
                            echo '<option value="' . $vehicleId . '" ' . $selected . '>' . $vehicleType . ' ' . $vehicleModel . ' ' . $vehicle_pln . ' / location: ' . $vehicle_location . '</option>';
                        }
                    }
                    ?>
                </select>
